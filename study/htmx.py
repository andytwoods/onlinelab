...
class HTMXStudyListView(generic.ListView):
    model = models.Study
...
class HTMXStudyCreateView(generic.CreateView):
    model = models.Study
    form_class = forms.StudyForm
...
class HTMXStudyDeleteView(generic.DeleteView):
    model = models.Study
    success_url = reverse_lazy("app_Study_htmx_list")
